...
Schema version 2 adds persisted ordering, production strict-mode configuration, request payload metadata, drafts, environment classification, and immutable safe history JSON.
